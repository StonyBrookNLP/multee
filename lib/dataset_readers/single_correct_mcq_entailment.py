...
@DatasetReader.register("single_correct_mcq_entailment")
class SingleCorrectMcqEntailmentReader(DatasetReader):
        ...
        with open(file_path, 'r') as entailment_file:
            ...
            for line in entailment_file:
                if line.strip():
                    ...
                    yield self.text_to_instance(premises, hypotheses, answer_index, relevant_sentence_idxs)
